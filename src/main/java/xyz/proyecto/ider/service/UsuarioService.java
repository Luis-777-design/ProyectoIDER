...
import xyz.proyecto.ider.repository.UsuarioRepository;
...
public class UsuarioService implements UsuarioRepository {
	...
	@Override
	public <S extends Usuario> S save(S entity) {  	//En uso save
	...
	@Override
	public void deleteById(Integer id) {		//En uso deleteById
		usuarioRepository.deleteById(id);
		
	}

	@Override
	public void delete(Usuario entity) {  //En uso delete
	...
	@Override
	public List<Usuario> findAll(Sort sort) {  //En uso findAll(sort)
